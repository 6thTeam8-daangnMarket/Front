        ...
        <PostBody>
          ...
          <form id="postForm" name="postForm">
            ...
            <DetailWrap>
              {/* 가격 설정 */}
                ...
                <div  style={{float: "right"}} >
                  {/* 가격 제안받기 */}
                  <input name="priceOffer" id="priceOffer" type="radio" value="priceOffer"/>
            ...
            <ContentsWrap>
              ...
              <textarea name="content" id="content" className="content" rows="10" style={{fontSize:"20px",width: "97%"}} 
